    ...
    public partial class raporekrani : Form
    {
        ...
        private void DoldurDataGridView(List<string> veriler)
        {
            ...
            if (veriler.Count >= 13) // İller ve Toplam değeri için toplam 13 veri bekleniyor.
            {
                ...
                dataGridView1.DefaultCellStyle.Font = new Font("Arial", 12, FontStyle.Regular); // Hücrelerin yazı tipini ve boyutunu ayarla
                dataGridView1.ColumnHeadersDefaultCellStyle.Font = new Font("Arial", 14, FontStyle.Bold); // Başlık yazısını kalın ve büyük yap
